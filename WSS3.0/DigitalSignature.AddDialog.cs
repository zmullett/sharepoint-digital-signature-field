...
namespace zmeng.SharePoint
{
	public partial class DigitalSignatureAddDialog : System.Web.UI.Page, System.Web.UI.ICallbackEventHandler
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
            ...
            string testPasswordAsyncScript = @"function TestPasswordAsync() { var ctlUsername = document.getElementById(""pedUser_downlevelTextBox""); var ctlPassword = document.getElementById(""txtPassword""); var ctlReason = document.getElementById(""ddlReason""); CallServer(ctlUsername.value + "";"" + EncryptPasswordForTransmission(ctlPassword.value) + "";"" + ctlReason.value, """"); }";
			string receiveServerDataScript = @"function ReceiveServerData(rValue) { if (rValue != ""x"" && rValue != ""?"" && rValue != """") { window.returnValue = rValue; window.close(); } else if (rValue == ""x"") { document.getElementById(""passwordMessageDiv"").innerHTML = ""The password entered is incorrect. Please try again.""; document.getElementById(""usernameMessageDiv"").innerHTML == """"; var control = document.getElementById(""txtPassword""); control.value = """"; control.focus(); } else if (rValue == ""?"") { document.getElementById(""passwordMessageDiv"").innerHTML = ""<br />""; document.getElementById(""usernameMessageDiv"").innerHTML = ""The username entered cannot be resolved.<br />Please try again.""; var control = document.getElementById(""txtPassword""); control.value = """";}}";
		...
		protected override void CreateChildControls()
		{
			...
			*/
			...
			cellPasswordValidation.Controls.Add(new LiteralControl(@"<div id=""passwordMessageDiv"" class=""ms-formvalidation""><br /></div>"));
		...
		public void RaiseCallbackEvent(String eventArgument)
		{
			...
			bool passwordGood = TestPassword(username, password);
		...
		private bool TestPassword(string qualifiedUsername, string password)
		{
